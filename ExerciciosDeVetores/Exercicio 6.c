...
#define MAX_NUMEROS 10 // Defina o tamanho máximo do vetor
...
int main() {
    ...
    int produto = calcular_produto(vetor, tamanho_vetor);

    // Exibe o resultado
    printf("O produto de todos os elementos do vetor é: %d\n", produto);
